...
HeltecTowerV2ExternalWatchdog external_watchdog;
...
bool HeltecTowerV2ExternalWatchdog::begin() {
...
void HeltecTowerV2ExternalWatchdog::loop() {
  if (millis() - last_feed_watchdog >= EXTERNAL_WATCHDOG_FEED_INTERVAL_MS) {
    feed();
  }
}

unsigned long HeltecTowerV2ExternalWatchdog::getIntervalMs() const {
...
void HeltecTowerV2ExternalWatchdog::feed() {
